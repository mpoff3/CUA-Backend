...
class LocalPlaywrightComputer(BasePlaywrightComputer):
    ...
    def _get_browser_and_page(self) -> tuple[Browser, Page]:
        ...
        # Get the Playwright access token from environment
        playwright_token = os.getenv('PLAYWRIGHT_ACCESS_TOKEN')
        ...
        browser = self._playwright.chromium.launch(
            ...
            env={
                "DISPLAY": ":0",
                "PLAYWRIGHT_ACCESS_TOKEN": playwright_token
            } if playwright_token else {"DISPLAY": ":0"}
        )
