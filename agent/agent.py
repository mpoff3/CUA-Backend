...
class Agent:
    ...
    def handle_item(self, item):
        ...
        if item["type"] == "reasoning" and "summary" in item:
    ...
    def run_full_turn(
        self, input_items, print_steps=True, debug=False, show_images=False, reasoning_summary="concise"
    ):
        ...
        while new_items[-1].get("role") != "assistant" if new_items else True:
            ...
            # Ensure we only use "concise" for reasoning summary as that's the only value supported by the API
            reasoning_param = {"summary": "concise"} if reasoning_summary != "none" else None
